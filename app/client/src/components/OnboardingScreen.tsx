...
const SPLASH_IMG = `${import.meta.env.BASE_URL}icons/gane-splash.webp`;
...
const featureSlides = [
  {
    ...
    description:
      "AI-powered probabilistic routing that learns from millions of trips. Get the fastest, safest, or most eco-friendly path — every time.",
  ...
  },
  {
    ...
    title: "43+ Languages",
    description:
      "Navigate in your language. Full voice guidance and interface translation for over 43 languages, including RTL support for Hebrew and Arabic.",
  ...
  },
  {
    ...
    description:
      "Crystal-clear turn-by-turn voice guidance with natural speech synthesis. Hands-free navigation that keeps you safe on the road.",
  ...
  },
  {
    ...
    title: "Safety First",
    description:
      "Real-time hazard detection, speed limit warnings, and driver fatigue monitoring. Your safety is our top priority.",
  ...
  },
  {
    ...
    description:
      "Live traffic intelligence from millions of sensors and connected vehicles. Avoid congestion before it happens.",
...
const panelGuide = [
  {
    icon: Hexagon,
    name: "Smart Parking",
    desc: "Find available spots in real-time with occupancy prediction",
    color: "oklch(0.82 0.15 192)",
  },
  {
    icon: Bolt,
    name: "EV Charging",
    desc: "Locate charging stations with live availability and pricing",
    color: "oklch(0.75 0.18 150)",
  },
  {
    icon: Atom,
    name: "Weather",
    desc: "Hyper-local weather affecting your route and driving conditions",
    color: "oklch(0.72 0.14 180)",
  },
  {
    icon: Antenna,
    name: "V2X Network",
    desc: "Vehicle-to-everything communication for intersection safety",
    color: "oklch(0.55 0.22 264)",
  },
  {
    icon: Diamond,
    name: "Digital Twin",
    desc: "3D city model with real-time traffic simulation",
    color: "oklch(0.72 0.14 180)",
  },
  {
    icon: Gauge,
    name: "Driver Score",
    desc: "Gamified driving analytics with safety and eco scoring",
    color: "oklch(0.80 0.16 75)",
  },
  {
    icon: TowerControl,
    name: "Fleet Command",
    desc: "Multi-vehicle fleet management and optimization",
    color: "oklch(0.55 0.22 264)",
  },
  {
    icon: Gem,
    name: "Wallet",
    desc: "Integrated payments for tolls, parking, and fuel",
    color: "oklch(0.80 0.16 75)",
  },
  {
    icon: Crosshair,
    name: "Report Incident",
    desc: "Dashcam evidence capture and incident reporting",
    color: "oklch(0.65 0.22 25)",
  },
  {
    icon: Orbit,
    name: "Transport Modes",
    desc: "Multi-modal routing: bus, train, bike, scooter, and walk",
    color: "oklch(0.60 0.25 300)",
  },
  {
    icon: Layers,
    name: "Map Layers",
    desc: "Toggle satellite, traffic, transit, and cycling overlays",
    color: "oklch(0.72 0.14 180)",
  },
  {
    icon: Sparkles,
    name: "Analytics",
    desc: "Trip history, patterns, and driving insights dashboard",
    color: "oklch(0.80 0.16 75)",
  },
  {
    icon: CircuitBoard,
    name: "Spec Vault",
    desc: "Complete engineering specification with PDF export",
    color: "oklch(0.60 0.25 300)",
  },
  {
    icon: Cpu,
    name: "System Architecture",
    desc: "2,246 Rust crates across 20 layers with build pipeline",
    color: "oklch(0.72 0.14 120)",
  },
  {
    icon: BrainCircuit,
    name: "Command Center",
    desc: "Mission control with live metrics and AI model status",
    color: "oklch(0.82 0.15 192)",
  },
];
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 30% 70%, oklch(0.82 0.15 192 / 15%) 0%, transparent 50%), radial-gradient(ellipse at 70% 30%, oklch(0.55 0.22 264 / 12%) 0%, transparent 50%)",
          }}
        />
      </div>
          ...
          >
            <div className="absolute inset-0">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, oklch(0.08 0.02 264 / 50%), oklch(0.08 0.02 264 / 95%))",
                }}
              />
            </div>
            ...
            >
              <motion.div
                ...
                style={{
                  ...
                  border: "1px solid oklch(0.82 0.15 192 / 30%)",
                  boxShadow: "0 0 40px oklch(0.82 0.15 192 / 15%)",
                }}
              >
              ...
              <p className="text-sm text-white/40 max-w-xs mx-auto leading-relaxed">
                Next-generation intelligent navigation powered by the Global
            ...
            >
              <button
                ...
                style={{
                  ...
                  boxShadow: "0 0 30px oklch(0.82 0.15 192 / 30%)",
                }}
              >
              ...
              <button
                onClick={skip}
                className="w-full py-3 text-sm text-white/30 hover:text-white/50 transition-colors mt-2"
              >
                Skip intro
              </button>
            </motion.div>
        ...
        {phase === "features" && (
          ...
          >
            <div className="flex-1 flex flex-col items-center justify-center">
              ...
              >
                {(() => {
                  const Icon = featureSlides[featureIdx].icon;
                  return (
                    <Icon
                      className="w-12 h-12"
                      style={{ color: featureSlides[featureIdx].color }}
                    />
                  );
                })()}
              </motion.div>
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              {featureSlides.map((_, idx) => (
                <div
                  key={idx}
                  className={`h-1.5 rounded-full transition-all duration-300 ${idx === featureIdx ? "w-6 bg-gane-cyan" : "w-1.5 bg-white/15"}`}
                />
              ))}
            </div>
            ...
            >
              {featureIdx === featureSlides.length - 1
                ? "Explore Panels"
                : "Continue"}
          ...
          >
            ...
            <div className="text-center mb-6">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span
                  className="text-[10px] text-gane-cyan uppercase tracking-[0.2em] font-semibold"
                  style={{ fontFamily: "Syne, sans-serif" }}
                >
                  {panelPage === 0
                    ? "Core Intelligence"
              ...
              <p className="text-xs text-white/30 mt-1">
                Page {panelPage + 1} of {panelPages.length} — Tap each panel in
            ...
            <div className="flex items-center justify-center gap-2 mb-4 mt-4">
              {panelPages.map((_, idx) => (
                <div
                  key={idx}
                  className={`h-1.5 rounded-full transition-all duration-300 ${idx === panelPage ? "w-6 bg-gane-cyan" : "w-1.5 bg-white/15"}`}
                />
              ))}
            </div>
        ...
        {phase === "ready" && (
          ...
          >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <motion.div
                  ...
                  style={{
                    background: "oklch(0.82 0.15 192 / 15%)",
                    border: "1px solid oklch(0.82 0.15 192 / 30%)",
                    boxShadow: "0 0 40px oklch(0.82 0.15 192 / 20%)",
                  }}
                >
            ...
            <h1 className="text-2xl font-bold text-white mb-2 font-mono">
              {typedText}
              <span className="cursor-blink text-gane-cyan">|</span>
            </h1>
            <p className="text-sm text-white/30 text-center max-w-xs">
              16 smart panels, 168 Rust crates, 14,661 tests. Your mission
              control awaits.
            </p>
