    ...
    >
      <div className="flex flex-col items-center gap-4">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, oklch(0.65 0.15 220), oklch(0.55 0.18 260))",
          }}
        />
  ...
  return (
    <ComponentErrorBoundary componentName="AdminPanel" variant="admin">
      <Suspense fallback={<RouteLoadingSkeleton />}>
        <AdminPanel onSwitchToUser={() => setLocation("/")} />
      </Suspense>
...
function Router() {
  ...
  // Base-aware routing: BASE_URL is "/" locally and "/<repo>/" on GitHub Pages.
