//! Physics and traffic rule constraints engine.

use serde::{Deserialize, Serialize};

/// Entry in the ConstraintEngine.
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = ConstraintEngine::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = ConstraintEngine::default();
        assert_eq!(s.violations(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = ConstraintEngine::new(100);
    ...
    #[test]
    fn test_capacity() {
        let mut s = ConstraintEngine::new(2);
        assert!(s.add(make_entry(1)));
