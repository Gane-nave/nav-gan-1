//! Automatic sensor calibration during navigation.

use serde::{Deserialize, Serialize};

/// Entry in the SensorCalibrator.
...
impl Default for SensorCalibrator {
    fn default() -> Self {
        Self::new(10_000)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = SensorCalibrator::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = SensorCalibrator::default();
        assert_eq!(s.calibrations(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = SensorCalibrator::new(100);
    ...
    #[test]
    fn test_capacity() {
        let mut s = SensorCalibrator::new(2);
        assert!(s.add(make_entry(1)));
