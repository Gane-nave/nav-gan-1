//! Navigation explainability — why routes and reroutes were chosen.

use serde::{Deserialize, Serialize};

/// Entry in the ExplainEngine.
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = ExplainEngine::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = ExplainEngine::default();
        assert_eq!(s.explanations(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = ExplainEngine::new(100);
