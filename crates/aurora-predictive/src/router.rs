...
/// Core engine for Predictive pre-departure route planning.
...
impl Default for PredictiveRouter {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn new_empty() {
        let e = PredictiveRouter::new();
        assert_eq!(e.count(), 0);
    }
    #[test]
    fn default_impl() {
        let e = PredictiveRouter::default();
        assert!(e.is_active());
    }
    #[test]
    fn add_and_get() {
        let mut e = PredictiveRouter::new();
