//! Adversarial tests for gane-migration

use gane_migration::plan::{MigrationPlan, MigrationStep, StepStatus};
use gane_migration::runner::{MigrationRunner, RunResult};
use gane_migration::version::SchemaVersion;
