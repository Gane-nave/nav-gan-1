...
use gane_metrics::export::render_prometheus;
use gane_observability::openapi;
...
pub async fn get_dashboard(State(state): State<Arc<AppState>>) -> Json<gane_web::DashboardData> {
    let gnss = state.gnss.read();
    let integrity = state.integrity.read();
    let continuity = state.continuity.read();
    ...
    let (position, sim_speed, _sim_heading) = if let Some(fused) = pos.as_ref() {
        ...
        (
            gane_web::dashboard::PositionData {
    ...
    let satellites = gane_web::dashboard::SatelliteData {
        tracked: sim_tracked,
    ...
    let traffic_segments = vec![
        gane_web::dashboard::TrafficSegment {
            start: [32.083, 34.780],
            end: [32.087, 34.774],
            speed_ratio: 0.85,
            color: "#10b981".into(),
    ...
    let fleet_vehicles = vec![
        gane_web::dashboard::VehicleInfo {
            id: "TLV-001".into(),
    ...
    // Route simulation
    let route = gane_web::dashboard::RouteData {
        active: true,
    ...
    let data = gane_web::DashboardData {
        position,
        route,
        satellites,
        integrity: gane_web::dashboard::IntegrityData {
            level: int_level,
        ...
        traffic: gane_web::dashboard::TrafficData {
        ...
        fleet: gane_web::dashboard::FleetData {
            enabled: true,
            vehicles_tracked: 3,
            nearby_vehicles: fleet_vehicles,
        },
        emergency: gane_web::dashboard::EmergencyData {
            active: false,
        ...
        city: gane_web::dashboard::CityData {
            connected: true,
        ...
        metrics: gane_web::dashboard::MetricsData {
        ...
        health: gane_web::dashboard::HealthData {
        ...
        pnt: gane_web::dashboard::PntData {
        ...
        deep_layers: gane_web::dashboard::DeepLayersData {
        ...
        v2x: gane_web::dashboard::V2xData {
        ...
        indoor: gane_web::dashboard::IndoorData {
            is_indoor: false,
            position_x: 0.0,
            position_y: 0.0,
            floor: 0,
        ...
        ar_nav: gane_web::dashboard::ArNavData {
            active: true,
            elements_count: 12,
