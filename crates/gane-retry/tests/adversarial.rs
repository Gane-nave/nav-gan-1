//! Adversarial tests for gane-retry

use gane_retry::backoff::{add_jitter, BackoffIter, BackoffStrategy};
use gane_retry::budget::RetryBudget;
use gane_retry::policy::{ErrorKind, RetryDecision, RetryPolicy, RetryPolicyConfig};
