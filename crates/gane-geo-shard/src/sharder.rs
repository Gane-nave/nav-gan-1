//! Geo-sharding for scalable regional processing.

use serde::{Deserialize, Serialize};

/// Entry in the GeoSharder.
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = GeoSharder::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = GeoSharder::default();
        assert_eq!(s.lookups(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = GeoSharder::new(100);
