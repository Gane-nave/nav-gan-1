//! Navigation state machine (driving/stopped/tunnel/lost).

use serde::{Deserialize, Serialize};

/// Entry in the NavStateMachine.
...
impl Default for NavStateMachine {
    fn default() -> Self {
        Self::new(10_000)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = NavStateMachine::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = NavStateMachine::default();
        assert_eq!(s.transitions(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = NavStateMachine::new(100);
    ...
    #[test]
    fn test_capacity() {
        let mut s = NavStateMachine::new(2);
        assert!(s.add(make_entry(1)));
