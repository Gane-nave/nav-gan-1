//! Adversarial tests for gane-bounded-queue.

use gane_bounded_queue::BoundedQueue;
...
fn adversarial_capacity_one() {
    ...
    assert_eq!(q.push(1), gane_bounded_queue::PushResult::Ok);
    assert_eq!(q.push(2), gane_bounded_queue::PushResult::Full);
    assert_eq!(q.pop(), Some(1));
    assert_eq!(q.push(3), gane_bounded_queue::PushResult::Ok);
