//! Geo-distributed consistency across regions.

use serde::{Deserialize, Serialize};

/// Entry in the GeoDistSync.
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = GeoDistSync::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = GeoDistSync::default();
        assert_eq!(s.syncs(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = GeoDistSync::new(100);
