/// platform android: detect, configure, optimize, monitor, log
/// Phase 1809
...
impl Default for PlatformAndroid {
    fn default() -> Self {
        Self::new()
    }
}

impl PlatformAndroid {
    pub fn new() -> Self {
        Self {
            detect_ok: true,
            configure_ok: true,
