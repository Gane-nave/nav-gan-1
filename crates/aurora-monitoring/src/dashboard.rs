...
pub fn aurora_overview_dashboard() -> DashboardDefinition {
    DashboardBuilder::new("AURORA NAV Overview", "aurora-overview")
        ...
        .add_row(DashboardRow {
            ...
            panels: vec![
                PanelDefinition {
                    ...
                    query: "rate(aurora_http_requests_total[5m])".to_string(),
                    grid_pos: (0, 0, 12, 8),
                ...
                PanelDefinition {
                    ...
                    query:
                        "rate(aurora_http_errors_total[5m]) / rate(aurora_http_requests_total[5m])"
                            .to_string(),
                    grid_pos: (12, 0, 6, 8),
                ...
                PanelDefinition {
                    ...
                    query: "aurora_active_sessions".to_string(),
                    grid_pos: (18, 0, 6, 8),
                    unit: None,
                    thresholds: vec![],
                },
        ...
        .add_row(DashboardRow {
            ...
            panels: vec![
                PanelDefinition {
                    ...
                    panel_type: PanelType::Graph,
                    query: "aurora_gnss_tracked_satellites".to_string(),
                    grid_pos: (0, 8, 12, 8),
                    unit: None,
                    thresholds: vec![
                        (4.0, "red".to_string()),
                ...
                PanelDefinition {
                    ...
                    panel_type: PanelType::Graph,
                    query: "aurora_position_accuracy_meters".to_string(),
                    grid_pos: (12, 8, 12, 8),
        ...
        .add_row(DashboardRow {
            ...
            panels: vec![
                PanelDefinition {
                    ...
                    panel_type: PanelType::Gauge,
                    query: "aurora_slo_api_availability_ratio".to_string(),
                    grid_pos: (0, 16, 8, 8),
                    unit: Some("percentunit".to_string()),
                    thresholds: vec![
                        (0.99, "red".to_string()),
                ...
                PanelDefinition {
                    ...
                    panel_type: PanelType::Gauge,
                    query: "aurora_slo_error_budget_remaining".to_string(),
                    grid_pos: (8, 16, 8, 8),
                    unit: Some("percentunit".to_string()),
                    thresholds: vec![
                        (0.0, "red".to_string()),
                ...
                PanelDefinition {
                    ...
                    panel_type: PanelType::Stat,
                    query: "aurora_slo_burn_rate".to_string(),
                    grid_pos: (16, 16, 8, 8),
...
pub fn aurora_navigation_dashboard() -> DashboardDefinition {
    DashboardBuilder::new("AURORA NAV Navigation", "aurora-navigation")
        ...
        .add_row(DashboardRow {
            ...
            panels: vec![
                PanelDefinition {
                    ...
                    query: "aurora_gnss_constellation_status".to_string(),
                    grid_pos: (0, 0, 24, 8),
                    unit: None,
                    thresholds: vec![],
                },
                PanelDefinition {
                    ...
                    panel_type: PanelType::Graph,
                    query: "rate(aurora_fusion_measurements_total[1m])".to_string(),
                    grid_pos: (0, 8, 12, 8),
                ...
                PanelDefinition {
                    ...
                    panel_type: PanelType::Graph,
                    query: "aurora_integrity_score".to_string(),
                    grid_pos: (12, 8, 12, 8),
                    unit: None,
                    thresholds: vec![
                        (0.8, "red".to_string()),
...
mod tests {
    ...
    fn overview_dashboard_structure() {
        let dash = aurora_overview_dashboard();
        assert_eq!(dash.uid, "aurora-overview");
    ...
    fn navigation_dashboard_structure() {
        let dash = aurora_navigation_dashboard();
        assert_eq!(dash.uid, "aurora-navigation");
    ...
    fn dashboard_serializable() {
        ...
        assert!(json.contains("aurora-overview"));
        assert!(json.contains("aurora_http_requests_total"));
    }
