/// trans encrypt2: negotiate, encrypt, decrypt, rekey, log
/// Phase 2282

#[derive(Debug, Clone)]
pub struct TransEncrypt2 {
...
impl Default for TransEncrypt2 {
    fn default() -> Self {
        Self::new()
    }
}
