...
<title>G.A.N.E NAV — Global Autonomous Navigation Ecosystem</title>
...
<div id="app">
  ...
  <header id="header">
    <div class="logo">
      ...
      <div>
        <h1>G.A.N.E NAV</h1>
        <div class="subtitle">Global Autonomous Navigation Ecosystem</div>
      </div>
    </div>
...
mod tests {
    ...
    fn html_contains_gane_branding() {
        ...
        assert!(MAIN_HTML.contains("Global Autonomous Navigation Ecosystem"));
    }
