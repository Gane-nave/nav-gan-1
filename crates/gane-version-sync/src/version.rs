//! Version synchronization between maps, traffic, and clients.

use serde::{Deserialize, Serialize};

/// Entry in the VersionManager.
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = VersionManager::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = VersionManager::default();
        assert_eq!(s.mismatches(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = VersionManager::new(100);
    ...
    #[test]
    fn test_capacity() {
        let mut s = VersionManager::new(2);
        assert!(s.add(make_entry(1)));
