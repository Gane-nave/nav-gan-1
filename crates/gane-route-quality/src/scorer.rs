//! Route confidence and quality scoring engine.

use serde::{Deserialize, Serialize};

/// Entry in the RouteQualityScorer.
...
/// Route confidence and quality scoring engine.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RouteQualityScorer {
    entries: Vec<Entry>,
    evaluations: u64,
    max_entries: usize,
}

impl RouteQualityScorer {
...
impl Default for RouteQualityScorer {
    fn default() -> Self {
        Self::new(10_000)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = RouteQualityScorer::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = RouteQualityScorer::default();
        assert_eq!(s.evaluations(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = RouteQualityScorer::new(100);
    ...
    #[test]
    fn test_capacity() {
        let mut s = RouteQualityScorer::new(2);
        assert!(s.add(make_entry(1)));
