...
use gane_backpressure::controller::{FlowControlConfig, FlowController};
use gane_bloom::filter::BloomFilter;
use gane_bounded_queue::{BoundedQueue, PushResult};
use gane_btree::BTree;
use gane_cache::ttl::TtlCache;
use gane_circuit::breaker::{BreakerConfig, CircuitBreaker, State as BreakerState};
use gane_clock::HybridClock;
use gane_errors::recovery::DegradationManager;
use gane_features::flags::FlagRegistry;
use gane_histogram::bucket::Histogram;
use gane_lru::cache::LruCache;
use gane_perf::profiler::Profiler;
use gane_ratelimit::bucket::{BucketConfig, BucketLimiter};
use gane_retry::backoff::BackoffStrategy;
use gane_retry::policy::{RetryPolicy, RetryPolicyConfig};
use gane_snapshot::capture::SnapshotStore;
use gane_structured_log::filter::FilterChain;
...
impl ServiceRegistry {
    ...
    pub fn now(&mut self) -> gane_clock::HlcTimestamp {
