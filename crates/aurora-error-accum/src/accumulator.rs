//! Cumulative error correction for dead reckoning drift.

use serde::{Deserialize, Serialize};

/// Entry in the ErrorAccumulator.
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = ErrorAccumulator::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = ErrorAccumulator::default();
        assert_eq!(s.corrections(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = ErrorAccumulator::new(100);
    ...
    #[test]
    fn test_capacity() {
        let mut s = ErrorAccumulator::new(2);
        assert!(s.add(make_entry(1)));
