//! Adaptive sampling rate control for GPS and IMU.

use serde::{Deserialize, Serialize};

/// Entry in the SamplingController.
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = SamplingController::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = SamplingController::default();
        assert_eq!(s.adjustments(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = SamplingController::new(100);
    ...
    #[test]
    fn test_capacity() {
        let mut s = SamplingController::new(2);
        assert!(s.add(make_entry(1)));
