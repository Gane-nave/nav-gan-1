//! Deterministic navigation for reproducible output.

use serde::{Deserialize, Serialize};

/// Entry in the DeterminismGuard.
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = DeterminismGuard::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = DeterminismGuard::default();
        assert_eq!(s.replays(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = DeterminismGuard::new(100);
    ...
    #[test]
    fn test_capacity() {
        let mut s = DeterminismGuard::new(2);
        assert!(s.add(make_entry(1)));
