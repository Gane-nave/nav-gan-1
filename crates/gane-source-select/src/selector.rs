...
/// Core engine for Dynamic source selection — quality-based weighted blending.
...
mod tests {
    ...
    #[test]
    fn new_empty() {
        assert_eq!(SourceSelector::new().count(), 0);
    }
    #[test]
    fn default_impl() {
        assert!(SourceSelector::default().is_active());
    }
    #[test]
    fn add_get() {
        let mut e = SourceSelector::new();
        let id = e.add(1.0, "t");
