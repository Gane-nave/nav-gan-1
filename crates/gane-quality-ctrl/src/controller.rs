//! Global quality controller for system-wide health decisions.

use serde::{Deserialize, Serialize};

/// Entry in the QualityController.
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let s = QualityController::new(100);
        assert_eq!(s.count(), 0);
    }

    #[test]
    fn test_default() {
        let s = QualityController::default();
        assert_eq!(s.decisions(), 0);
    }

    #[test]
    fn test_add() {
        let mut s = QualityController::new(100);
    ...
    #[test]
    fn test_capacity() {
        let mut s = QualityController::new(2);
        assert!(s.add(make_entry(1)));
